                                ...
                                <div className="space-y-6">
                                    <div className="h-64 bg-white/5 border border-white/10 rounded-3xl relative overflow-hidden flex items-center justify-center">
                                        <div className="text-center p-6">
                                            <Navigation className="w-12 h-12 text-teal-500 mx-auto mb-4 opacity-50" />
                                            <h4 className="font-bold mb-1">Map Visualization Frozen</h4>
                                            <p className="text-gray-500 text-xs max-w-[200px] mx-auto">Interactive maps are temporarily paused. Manual address entry is required.</p>
                                            <button
                                                type="button"
                                                onClick={() => {
                                                    // Simulating a geo-lookup for demo purposes
                                                    setValue('location', { lat: 40.7128, lng: -74.0060 });
                                                    if (!watch('address')) setValue('address', 'Current Precinct District, City');
                                                }}
                                                className="mt-6 px-4 py-2 bg-white/5 border border-white/10 rounded-xl text-[10px] font-black uppercase tracking-widest text-teal-400 hover:bg-white/10 transition-all flex items-center gap-2 mx-auto"
                                            >
                                                <MapPin className="w-3 h-3" /> Set Default Coords
                                            </button>
                                        </div>
                                    </div>
